...
public class RoleServiceIMPL implements IRoleService{
    public static String ROLE_PATH = ConfigReadAndWriteFile.PATH+"role.txt";
    public static List<Role> roleList = new ConfigReadAndWriteFile<Role>().readFromFile(ROLE_PATH);
    @Override
    public List<Role> findAll() {
        ...
        new ConfigReadAndWriteFile<Role>().writeToFile(ROLE_PATH,roleList);
        return roleList;
    }
    @Override
